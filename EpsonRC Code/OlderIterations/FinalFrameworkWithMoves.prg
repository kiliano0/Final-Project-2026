...
Retry:
    Do
        ...
        ElseIf line$ = "MAXSPEED" Then
			Speed 100
			Accel 100, 100
            GoTo Retry
        
        ElseIf line$ = "SAFEMODE" Then
			Speed 10
			Accel 10, 10
            GoTo Retry
            ...
            Else
                ...
                ElseIf cmd$ = "GOP" Then
                    ...
                    Else
                        ...
                        Go XY(X_Coord, Y_Coord, -50, U_Coord + 90)
                        Go XY(X_Coord, Y_Coord, -154, U_Coord + 90)
                        'Print #201, "ACTIVATE_VAC"
                        Go XY(X_Coord, Y_Coord, -50, U_Coord + 90)

                        If movecount = 1 Then
                            Go XY(-20, 310, -50, 180)
                            Go XY(-20, 310, -154, 180)
                            'Print #201, "DEACTIVATE_VAC"
                            Wait 0.3
                            Go XY(-20, 310, -50, 180)
							Print #201, "READY"
                        ElseIf movecount = 2 Then
                            Go XY(-140, 310, -50, 180)
                            Go XY(-140, 310, -154, 180)
                            'Print #201, "DEACTIVATE_VAC"
                            Wait 0.3
                            Go XY(-140, 310, -50, 180)
                            Print #201, "READY"
                        ElseIf movecount = 3 Then
                            Go XY(-260, 310, -50, 180)
                            Go XY(-260, 310, -154, 180)
                            'Print #201, "DEACTIVATE_VAC"
                            Wait 0.3
                            Go XY(-260, 310, -50, 180)
                            Print #201, "READY"
